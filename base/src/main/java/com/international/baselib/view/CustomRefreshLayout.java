...
public class CustomRefreshLayout extends ViewGroup {
    ...
    private static final int HEADER_VIEW_WAITING_TIME = 1000;//头部view显示的时长
    ...
    private int pushDistance = 0;
        ...
        private CircleProgressView defaultProgressView = null;//默认的下拉刷新动画
//    private RefreshHeaderView mRefreshHeaderView = null;
...
//                        if (!mRefreshHeaderView.isAnimationDoing()) {
//                            mRefreshHeaderView.startBgAnimation();
//                        }
                ...
                //停止header中的动画
//                if (mRefreshHeaderView.isAnimationDoing()) {
//                    mRefreshHeaderView.stopBgAnimation();
//                }
                if (mScale) {
...
//            mRefreshHeaderView.updateXingxingPosition(distance, isRefreshing());
    ...
    public void setHeaderView(View child) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(
                mHeaderViewWidth, LayoutParams.MATCH_PARENT);
...
//                mHeaderViewWidth, LayoutParams.MATCH_PARENT);
        ...
        //=======测试=====
//        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(
//                mHeaderViewWidth, ScreenUtil.dip2px(CustomViewPagerRefreshLayout.getImageWidthHeight(context)));
...
//        mHeadViewContainer.addView(mRefreshHeaderView, layoutParams);
...
//        if (BuildConfig.DEBUG)LogF.d(TAG, "debug:onLayout childHeight = " + childHeight);
    ...
    public boolean isChildScrollToTop() {
        ...
        return !toolbarIsHite && !ViewCompat.canScrollVertically(mTarget, -1);
    ...
    public void setToolbarIsHite(boolean toolbarIsHite) {
        this.toolbarIsHite = toolbarIsHite;
    }
...
//                        }
            ...
            case MotionEvent.ACTION_CANCEL: {
                ...
                final int pointerIndex = MotionEventCompat.findPointerIndex(ev,
                        mActivePointerId) < 0 ? 0 : MotionEventCompat.findPointerIndex(ev,
                        mActivePointerId);
                final float y = MotionEventCompat.getY(ev, pointerIndex);
                final float overscrollTop = (y - mInitialMotionY) * DRAG_RATE;
                mIsBeingDragged = false;
    ...
    private class HeadViewContainer extends RelativeLayout {
        ...
        public HeadViewContainer(Context context) {
            super(context);
//            this.setBackground(context.getResources().getDrawable(R.drawable.refresh_header_bg));
        }

...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> implements IRecyclerView {
     ...
     * @param layoutResId  The layout_custom_banner_view resource id of each item.
     ...
     * simple to solve item will layout_custom_banner_view using all
    ...
    /**
     * When set to true, the item will layout_custom_banner_view using all span area. That means, if orientation
    ...
    /**
     * Return root layout_custom_banner_view of header
     */
    ...
    /**
     * Return root layout_custom_banner_view of footer
     */
    ...
    /**
     * @param layoutResId ID for an XML layout_custom_banner_view resource to load
     ...
     * Expand an expandable item
     *
     * @param position position of the item, which includes the header layout_custom_banner_view count.
     * @param animate  expand items with animation
     * @return the number of items that have been added.
     */
     ...
     *
     * @param position the position of the item, which includes the header layout_custom_banner_view count.
